package com.courtalon.thirdBootForm.configuration;
...
// cette classe est "chargée" avant le démarrage concret de l'application
// mais après initialisation du contexte spring
@Configuration
